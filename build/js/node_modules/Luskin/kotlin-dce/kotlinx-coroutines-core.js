(function (root, factory) {
  ...
  function AbstractCoroutine(parentContext, initParentJob, active) {
    ...
    this.parentContext_8be2vx$ = parentContext;
    this.context_p8rm81$_0 = this.parentContext_8be2vx$.plus_1fupul$(this);
    var tmp$ = initParentJob;
    if (tmp$) {
      tmp$ = true;
    }if (tmp$)
      this.initParentJob_8vd9i7$(this.parentContext_8be2vx$.get_j3r2sn$(Job$Key_getInstance()));
  }
  ...
  function withContext$lambda(closure$context, closure$block) {
    return function (uCont) {
      ...
      if (newContext === oldContext) {
        var coroutine = new ScopeCoroutine(newContext, uCont, true);
  ...
  DispatchedCoroutine.prototype.initParentForNativeUndispatchedCoroutine = function () {
  };
  ...
  function getOrCreateCancellableContinuation(delegate) {
    ...
    if (!true || !Kotlin.isType(delegate, DispatchedContinuation)) {
      var $receiver = new CancellableContinuationImpl(delegate, 1);
      if (Kotlin.isType(delegate, DispatchedContinuation))
        $receiver.initCancellability();
      return $receiver;
  ...
  CancellableContinuationImpl.prototype.isReusable_0 = function () {
    var tmp$;
    return true && get_isReusableMode(this.resumeMode) && (Kotlin.isType(tmp$ = this.delegate, DispatchedContinuation) ? tmp$ : throwCCE()).isReusable();
  };
  ...
  function EventLoop$processUnconfinedEvent$lambda(closure$task) {
    return function () {
      closure$task.run();
      return Unit;
    };
  ...
  EventLoop.prototype.processUnconfinedEvent = function () {
    ...
    EventLoop$processUnconfinedEvent$lambda(task)();
    return true;
  };
  ...
  JobSupport.prototype.initParentJob_8vd9i7$ = function (parent) {
    if (parent == null) {
  ...
  function JobImpl(parent) {
    ...
    this.initParentJob_8vd9i7$(parent);
  }
  ...
  collect$ObjectLiteral_14.$metadata$ = {kind: Kind_CLASS, interfaces: [FlowCollector]};
  ...
  function ScopeCoroutine(context, uCont, useInitNativeKludge) {
    ...
    this.uCont = uCont;
    var tmp$ = useInitNativeKludge;
    if (tmp$) {
      tmp$ = !true;
    }if (tmp$)
      this.initParentForNativeUndispatchedCoroutine();
  }
  ...
  ScopeCoroutine.prototype.initParentForNativeUndispatchedCoroutine = function () {
    this.initParentJob_8vd9i7$(this.parentContext_8be2vx$.get_j3r2sn$(Job$Key_getInstance()));
  };
